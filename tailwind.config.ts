  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Tokens do storybook — acesso direto no Tailwind
        ink:    '#111111',
        paper:  '#FDFBF5',
        amber: {
          DEFAULT: '#F59E0B',
      ...
      // Border radius — tudo zero (neobrutalism)
      borderRadius: {
        DEFAULT: '0px',
        none:    '0px',
        sm:      '0px',
        ...
        xl:      '0px',
        '2xl':   '0px',
        full:    '0px',   // exceção: avatares usam inline style
      },
      ...
      keyframes: {
        ...
        'stamp-in':       { from: { opacity: '0', transform: 'scale(.7) rotate(-8deg)' }, to: { opacity: '1', transform: 'scale(1) rotate(-3deg)' } },
        'nb-press':       { '0%,100%': { transform: 'translate(0,0)', boxShadow: '4px 4px 0 #111' }, '50%': { transform: 'translate(2px,2px)', boxShadow: '2px 2px 0 #111' } },
      },
      animation: {
